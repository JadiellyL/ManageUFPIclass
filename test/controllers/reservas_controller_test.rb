...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { date: @reserva.date, quantity: @reserva.quantity, sala_id: @reserva.sala_id, time_input: @reserva.time_input, time_output: @reserva.time_output, user_id: @reserva.user_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { date: @reserva.date, quantity: @reserva.quantity, sala_id: @reserva.sala_id, time_input: @reserva.time_input, time_output: @reserva.time_output, user_id: @reserva.user_id } }
